...
pub async fn initproc() {
    #[cfg(not(target_arch = "loongarch64"))]
    {
        ...
        command("/glibc/busybox echo latency measurements", glibc_home_dir.clone()).await;
        command("/glibc/lmbench_all lat_syscall -P 1 null", glibc_home_dir.clone()).await;
        command("/glibc/lmbench_all lat_syscall -P 1 read", glibc_home_dir.clone()).await;
        command("/glibc/lmbench_all lat_syscall -P 1 write", glibc_home_dir.clone()).await;

        command("/glibc/busybox mkdir -p /var/tmp", glibc_home_dir.clone()).await;
        command("/glibc/busybox touch /var/tmp/lmbench", glibc_home_dir.clone()).await;

        command("/glibc/lmbench_all lat_syscall -P 1 stat /var/tmp/lmbench", glibc_home_dir.clone()).await;
        command("/glibc/lmbench_all lat_syscall -P 1 fstat /var/tmp/lmbench", glibc_home_dir.clone()).await;
        command("/glibc/lmbench_all lat_syscall -P 1 open /var/tmp/lmbench", glibc_home_dir.clone()).await;

        command("/glibc/lmbench_all lat_select -n 100 -P 1 file", glibc_home_dir.clone()).await;

        command("/glibc/lmbench_all lat_sig -P 1 install", glibc_home_dir.clone()).await;
        command("/glibc/lmbench_all lat_sig -P 1 catch", glibc_home_dir.clone()).await;
        command("/glibc/lmbench_all lat_sig -P 1 prot lat_sig", glibc_home_dir.clone()).await;

        command("/glibc/lmbench_all lat_pipe -P 1", glibc_home_dir.clone()).await;

        command("/glibc/lmbench_all lat_proc -P 1 fork", glibc_home_dir.clone()).await;
        ...
        command("/glibc/lmbench_all lat_pagefault -P 1 /var/tmp/XXX", glibc_home_dir.clone()).await;
        command("/glibc/lmbench_all lat_mmap -P 1 512k /var/tmp/XXX", glibc_home_dir.clone()).await;

        command("/glibc/busybox echo file system latency", glibc_home_dir.clone()).await;
        command("/glibc/lmbench_all lat_fs /var/tmp", glibc_home_dir.clone()).await;

        command("/glibc/busybox echo Bandwidth measurements", glibc_home_dir.clone()).await;
        command("/glibc/lmbench_all bw_pipe -P 1", glibc_home_dir.clone()).await;
        command("/glibc/lmbench_all bw_file_rd -P 1 512k io_only /var/tmp/XXX", glibc_home_dir.clone()).await;
        command("/glibc/lmbench_all bw_file_rd -P 1 512k open2close /var/tmp/XXX", glibc_home_dir.clone()).await;
        command("/glibc/lmbench_all bw_mmap_rd -P 1 512k mmap_only /var/tmp/XXX", glibc_home_dir.clone()).await;
        command("/glibc/lmbench_all bw_mmap_rd -P 1 512k open2close /var/tmp/XXX", glibc_home_dir.clone()).await;

        command("/glibc/busybox echo context switch overhead", glibc_home_dir.clone()).await;
        command("/glibc/lmbench_all lat_ctx -P 1 -s 32 2 4 8 16 24 32 64 96", glibc_home_dir.clone()).await;
        ...
        command("/musl/busybox cp /musl/busybox /bin/mkdir", home_dir.clone()).await;
        ...
        command("/musl/busybox cp /musl/busybox /bin/chmod", home_dir.clone()).await;
        ...
        command("/musl/lmbench_all lat_syscall -P 1 stat /var/tmp/lmbench", home_dir.clone()).await;
        command("/musl/lmbench_all lat_syscall -P 1 fstat /var/tmp/lmbench", home_dir.clone()).await;
        command("/musl/lmbench_all lat_syscall -P 1 open /var/tmp/lmbench", home_dir.clone()).await;

        command("/musl/lmbench_all lat_select -n 100 -P 1 file", home_dir.clone()).await;
        ...
        command("/musl/lmbench_all lat_sig -P 1 prot lat_sig", home_dir.clone()).await;
        ...
        command("/musl/lmbench_all lat_pagefault -P 1 /var/tmp/XXX", home_dir.clone()).await;
        command("/musl/lmbench_all lat_mmap -P 1 512k /var/tmp/XXX", home_dir.clone()).await;
        ...
        command("/musl/busybox echo Bandwidth measurements", home_dir.clone()).await;
        command("/musl/lmbench_all bw_pipe -P 1", home_dir.clone()).await;
        command("/musl/lmbench_all bw_file_rd -P 1 512k io_only /var/tmp/XXX", home_dir.clone()).await;
        command("/musl/lmbench_all bw_file_rd -P 1 512k open2close /var/tmp/XXX", home_dir.clone()).await;
        command("/musl/lmbench_all bw_mmap_rd -P 1 512k mmap_only /var/tmp/XXX", home_dir.clone()).await;
        command("/musl/lmbench_all bw_mmap_rd -P 1 512k open2close /var/tmp/XXX", home_dir.clone()).await;

        command("/musl/busybox echo context switch overhead", home_dir.clone()).await;
        command("/musl/lmbench_all lat_ctx -P 1 -s 32 2 4 8 16 24 32 64 96", home_dir.clone()).await;
